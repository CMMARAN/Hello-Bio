...
#        print(str("n"),n)
        ...
        print(str(t)+"\t"+str(self.I_inj(t))+"\t"+str(self.I_Na(V, m, h))+"\t"+str(self.I_K(V, n))+"\t"+str(self.I_L(V))+"\t"+str(self.C_m)+"\t"+str(V)+"\t"+str(m)+"\t"+str(h)+"\t"+str(n)+"\t"+str(self.alpha_m(V))+"\t"+str(self.alpha_h(V))+"\t"+str(self.alpha_n(V))+"\t"+str(self.beta_m(V))+"\t"+str(self.beta_h(V))+"\t"+str(self.beta_n(V))+"\t"+str(dVdt)+"\t"+str(dmdt)+"\t"+str(dhdt)+"\t"+str(dndt))
#        print(str(t)+"\t"+str(V)+"\t"+str(dVdt)+"\t"+str(m)+"\t"+str(dmdt)+"\t"+str(h)+"\t"+str(dhdt)+"\t"+str(n)+"\t"+str(dndt))
